...
$("#ardoraQuest").html("<img id='playSound' class='imaLeft' src='Dise__o_WEB_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
...
$("#cellG"+i.toString()).css("background","-webkit-gradient(linear, left top, left bottom, from("+color1+"), to("+color2+"))");
$("#cellG"+i.toString()).css("background","-webkit-linear-gradient("+color1+", "+color2+")");
$("#cellG"+i.toString()).css("background","-moz-linear-gradient(top, "+color1+", "+color2+")");
$("#cellG"+i.toString()).css("background","-ms-linear-gradient("+color1+", "+color2+")");
$("#cellG"+i.toString()).css("background","-o-linear-gradient("+color1+", "+color2+")");
$("#cellG"+i.toString()).css("background","linear-gradient("+color1+", "+color2+")");
$("#cellG"+i.toString()).css("filter","progid:DXImageTransform.Microsoft.Alpha(startColorstr='"+color1+"', endColorstr='"+color2+"')");
